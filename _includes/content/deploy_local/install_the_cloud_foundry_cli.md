...
The [Cloud Foundry Command Line Interface (cf CLI)](https://docs.cloudfoundry.org/cf-cli/) is a tool used to deploy and manage your applications, users, and services in a CF environment.
...
- For more tips on using a command line, check out [this quick and dirty overview of the command line and how to use it](https://www.davidbaumgold.com/tutorials/command-line/).
